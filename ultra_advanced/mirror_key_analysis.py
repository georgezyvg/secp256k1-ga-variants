...
def analyze_curve_results_with_true_key(results: dict, true_private_key: bytes, elite_keys: List[bytes]) -> dict:
    """Analyze how close the GA got to the true private key"""
    analysis = {
...
def run_multi_curve_test():
    ...
    for i, (curve_name, curve) in enumerate(CURVES_TO_TEST):
        ...
        if 'error' not in results:
            ...
            print(f"\n   🏆 CLOSEST KEY FOUND (checking best + top 10 elite):")
