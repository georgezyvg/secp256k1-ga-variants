...
try:
    ...
    import subprocess
    import sys
    subprocess.check_call([sys.executable, "-m", "pip", "install", "numpy", "ecdsa", "pycryptodome", "scikit-learn"])
...
class BitcoinCrypto:
    ...
    def cleanup_cache(self):
        ...
        with self.cache_lock:
            if len(self.pubkey_cache) > 10000:  # Limit cache size
