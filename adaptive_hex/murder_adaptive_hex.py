...
class SingleTargetConfig:
    ...
    POSITION_DECAY: float = 0.5          # Lighter decay
    GLOBAL_WEIGHT_DECAY: float = 0.8    # Lighter global decay
    MIN_POSITION_WEIGHT: float = 0.001     # Higher minimum
    MAX_POSITION_WEIGHT: float = 1     # Lower maximum

    # Single target specific
    MAX_ROUNDS: int = 1000000000000000000                 # More rounds for single target
